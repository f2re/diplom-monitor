...
- **Pinia** for state management (auth, week progress)
- **Vite** for fast development and bundling
- **Axios** for API communication
- **Headless UI / Radix Vue** for accessible primitives
...
## Project Specific Focus: "Weeks Until Diploma"
- **Interactive Grid**: Implementing the week grid with responsive sizing and status colors.
- **Emoji Support**: Integration of emoji picker and rendering chosen emojis in the grid.
- **Mobile-First**: Ensuring the grid is usable on small screens with proper touch targets.
- **Progress Tracking**: Real-time updates of week status using Pinia and Axios.
